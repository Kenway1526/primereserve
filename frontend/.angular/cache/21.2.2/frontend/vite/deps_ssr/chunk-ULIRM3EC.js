...
var VALID_HOST_REGEX = /^[a-z0-9.:-]+$/i;
var INVALID_PREFIX_REGEX = /^[/\\]{2}|(?:^|[/\\])\.\.?(?:[/\\]|$)/;
...
var ServerPlatformLocation = class _ServerPlatformLocation {
  ...
  constructor() {
    const config2 = inject(INITIAL_CONFIG, {
      optional: true
    });
    if (!config2) {
      return;
...
var safeParser = getDefaultExportFromCjs2(safeParseExports);
var boolbase$1;
...
var AngularServerApp = class {
  ...
  async handleRendering(request, matchedRoute, requestContext) {
    ...
    if (result2.redirectTo) {
      return createRedirectResponse(result2.redirectTo, responseInit.status);
    }
    if (renderMode === RenderMode.Prerender) {
...
//# sourceMappingURL=chunk-ULIRM3EC.js.map
